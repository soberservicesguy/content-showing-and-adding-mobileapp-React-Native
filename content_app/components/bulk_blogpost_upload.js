			...
			// e.g a social post, textinput which lets user to enter text, takes persons id as assigned object
				<View style={styles.outerContainer}>
					...
					<View style={styles.textinputContainer}>
						...
						<Button 
							title={'UPLOAD BLOPOST EXCEL SHEET HERE'}
							style={styles.buttonWithoutBG}
							onPress={async () => {
								try {
					...
					<Button 
						...
						onPress={ () => {
							...
							formData.append('excel_sheet_for_blogpost', {uri: this.state.excel_sheet.uri, name: this.state.excel_sheet.name, type: this.state.excel_sheet.type})
