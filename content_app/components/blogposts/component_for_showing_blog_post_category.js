...
class ComponentForShowingBlogPostCategory extends Component {
	constructor(props) {
		super(props);
// STATE	
		this.state = {
...
ComponentForShowingBlogPostCategory.defaultProps = {
...
export default ComponentForShowingBlogPostCategory;
