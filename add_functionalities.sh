...
# ${1} pass the app name to it

# echo "HELLO" | tr '[:upper:]' '[:lower:]'  # turns into lowercase

app_directory="${PWD##*/}"  # app name is passed while configuring in gradle and similar files
app_name= echo $app_directory | tr '[:upper:]' '[:lower:]'
# app_name='webrtc'
